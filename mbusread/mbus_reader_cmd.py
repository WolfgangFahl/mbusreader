...
class MBusCommunicator:
    ...
    def __init__(self,args:argparse.Namespace):
        ...
        self.mqtt_config = MqttConfig.load_from_yaml_file(args.mqtt_config) if args.mqtt_config else None

        self.reader = MBusReader(device=device, io_config=io_config, i18n=i18n, debug=args.debug)
